...
class HistoryTableViewController: UITableViewController {
    ...
    private func getHistoryList() {
        ...
        let getHistoryRoute = API_URI + versionV1 + "/accounts/" + UserPref.getUserPrefByKey("userUuid") + "/history"
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.statusLabel.text = generateHistoryText(historyArray[indexPath.row]["type"].stringValue, startTime: historyArray[indexPath.row]["startTime"].stringValue, hangup: historyArray[indexPath.row]["answer"].stringValue)
